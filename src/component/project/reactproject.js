...
const Navbar = () => {
  ...
  <div className="container">
    <a className="navbar-brand" href="#">AnshumanPay</a>
    ...
    <div className={`collapse navbar-collapse {show ? "show":""}`} >
      <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
        ...
        <li className="nav-item">
          <NavLink className="nav-link" to="/Service" onClick="">Services
        </NavLink>
        </li>
        <li className="nav-item">
      ...
      <form className="d-flex">
        ...
        <button className="btn  btn-style" type="submit">Sig in</button>
        <button className="btn  btn-style" type="submit">sig up</button>
